# 📋 Das steht im Lehrplan: Technische Schwerpunkte (Rahmenlehrplan 2025)
...
Der novellierte Rahmenlehrplan 2025 fordert von angehenden Meisterinnen und Meistern umfassende Handlungskompetenzen in der Diagnose, Reparatur, Systemintegration und Wartung von komplexen Land- und Baumaschinen.

Neben der vernetzten Elektronik und Software (ISOBUS / CAN-Bus) umfasst die Ausbildung folgende **zentrale technische Fachgebiete**:
...
## ⏱️ Stundenanteile der technischen Module im Rahmenlehrplan

| Modul / Handlungsfeld | Gesamtdauer | Technische Schwerpunkte |
| :--- | :---: | :--- |
